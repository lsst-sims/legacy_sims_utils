...
def utcFromTai(tai):
    ...
    utc_arr = numpy.arange(tai - 1.0*dt_approx, tai+1.0*dt_approx, 1.0e-6)
    tai_arr = numpy.array([taiFromUtc(utc) for utc in utc_arr])

    return numpy.interp(tai, tai_arr, utc_arr)
